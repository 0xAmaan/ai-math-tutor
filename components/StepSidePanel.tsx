...
export const StepSidePanel = ({
  ...
  const steps =
    stepRoadmap && stepRoadmap.length > 0
      ? stepRoadmap
  ...
  return (
    ...
    >
      {/* Header with title */}
      <div
        className="p-4 border-b border-zinc-700 flex items-center justify-between"
        ...
        <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex-1">
              ...
              {currentEquation ? (
                <p className="text-base text-emerald-400 font-mono">
                  {currentEquation}
                </p>
              ) : (
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isCurrent && (
                    <Circle className="w-4 h-4 text-blue-500 shrink-0 mt-0.5 animate-pulse fill-blue-500" />
                  )}
                  {isPending && (
